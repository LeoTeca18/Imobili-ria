...
<nav class="therichpost-sidebar therichpost-collapse therichpost-white therichpost-animate-left"
    ...
    <div class="therichpost-bar-block">
        <a href="vendidos" class="therichpost-bar-item therichpost-button therichpost-padding"><i
                class="fa fa-home fa-fw"></i>Imóveis Vendidos</a>
        <a href="alugados" class="therichpost-bar-item therichpost-button therichpost-padding"><i
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Imobiliaria\resources\views/funcionario/negociante/ini.blade.php ENDPATH**/ ?>