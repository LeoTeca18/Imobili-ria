...
<nav class="therichpost-sidebar therichpost-collapse therichpost-white therichpost-animate-left"
    ...
    <div class="therichpost-bar-block">
        ...
        <a href="#" class="therichpost-bar-item therichpost-button therichpost-padding"><i
                class="fa fa-user fa-fw"></i>Fazer Pedido</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Imobiliaria\resources\views/proprietario/inicial.blade.php ENDPATH**/ ?>