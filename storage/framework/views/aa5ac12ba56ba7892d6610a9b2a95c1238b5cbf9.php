...
<nav class="therichpost-sidebar therichpost-collapse therichpost-white therichpost-animate-left"
    ...
    <div class="therichpost-bar-block">
        ...
        <a href="negados" class="therichpost-bar-item therichpost-button therichpost-padding therichpost-blue"><i
...
<div class="therichpost-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="therichpost-container" style="padding-top:22px">
        <h5><b><i class="fa fa-dashboard"></i>Pedidos Negados</b></h5>
    </header>
...
<?php echo $__env->make('layouts.gestor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Imobiliaria\resources\views/funcionario/gestor/negados.blade.php ENDPATH**/ ?>